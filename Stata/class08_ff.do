...
// Import FF 3-factors
import delimited "ff_factors.csv", varn(4) rowrange(5:1097) clear
ren v1 date
save _junk, replace
// Import 25 (5x5) portfolios formed on size and book-to-market ratio
import delimited "25portfolios.csv", varn(20) rowrange(21:1113) clear
ren v1 date
...
// CAPM and 25 (5x5) portfolios formed on market value and book-to-makret ratio (before 1965)
...
twoway (scatter mean b_mkt in 1/25, mlabel(port) xscale(range(0.9 1.9)) xtitle({&beta}) ///
	ytitle("return") subtitle("CAPM: from 1926 to 1964") legend(off)) (lfit mean b_mkt)
...
// Fama-French 3-factor model and 25 (5x5) portfolios formed on market value and book-to-makret ratio
...
// Import FF 5-factors
import delimited "ff5.csv", varn(4) rowrange(5:653) clear
ren v1 date
save _junk, replace
// Import 25 (5x5) portfolios formed on size and book-to-market ratio
import delimited "25portfolios.csv", varn(20) rowrange(21:1113) clear
...
// Fama-French 5-factor model and 25 (5x5) portfolios formed on market value and book-to-makret ratio
